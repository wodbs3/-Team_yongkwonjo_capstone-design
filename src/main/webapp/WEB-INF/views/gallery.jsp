		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-3">
					<div id="logo">
						<a href="index.html"><img src="resources/img/logo.png" width="160" height="34" alt="City tours" data-retina="true" class="logo_normal">
						</a>
						<a href="index.html"><img src="resources/img/logo_sticky.png" width="160" height="34" alt="City tours" data-retina="true" class="logo_sticky">
						</a>
					</div>
				</div>
				<nav class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <img src="resources/img/logo_sticky.png" width="160" height="34" alt="City tours" data-retina="true">
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="social_footer">
                        <ul>
                            <li><a href="#"><i class="resources/icon-facebook"></i></a></li>
                            <li><a href="#"><i class="resources/icon-twitter"></i></a></li>
                            <li><a href="#"><i class="resources/icon-google"></i></a></li>
                            <li><a href="#"><i class="resources/icon-instagram"></i></a></li>
                            <li><a href="#"><i class="resources/icon-pinterest"></i></a></li>
                            <li><a href="#"><i class="resources/icon-vimeo"></i></a></li>
                            <li><a href="#"><i class="resources/icon-youtube-play"></i></a></li>
                            <li><a href="#"><i class="resources/icon-linkedin"></i></a></li>
                        </ul>
                        <p>© Citytours 2015</p>
                    </div>
                </div>
