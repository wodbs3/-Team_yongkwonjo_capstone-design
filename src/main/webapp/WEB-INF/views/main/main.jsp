...
<!--                   <div class="tp-caption NotGeneric-SubTitle   tp-resizeme" id="slide-140-layer-4" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['52','52','52','51']" data-fontweight="['400','500','500','500']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1500,"speed":2000,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"frame":"999","to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; white-space: nowrap; font-weight: 400;font-family:Montserrat;">TOURS HOTELS RESTAURANTS</div> -->
               ...
               <!-- SLIDE  -->
               <li data-index="rs-141" data-transition="fadetotopfadefrombottom" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500" data-thumb="/resources/rev-slider-files/assets/100x50_notgeneric_bg5.jpg" data-rotate="0" data-saveperformance="off" data-title="Chill" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                  <!-- MAIN IMAGE -->
                  <img src="/resources/img/slides/slide2.JPG" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                  <!-- LAYERS -->
...
<!--    </div>    -->
   <div class="row">
      ...
      <div class="portlet-title">
         ...
         <div class="portlet-body" style="text-align: center; height: 416.07px;">
         <h4><strong><p class = "bginfo" id="chatLog1" class="chat_log1" readonly></p></strong></h4>

         <h4><strong><p class = "bginfo" id="chatLog2" class="chat_log2" readonly></p></strong></h4><br>
         <h4><strong><p class = "bginfo" id="chatLog7" class="chat_log7" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog10" class="chat_log10" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog13" class="chat_log13" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog16" class="chat_log16" readonly></p></strong></h4>
   	<img src="" id="img1" />
      ...
      <div class="portlet-title">
         ...
         <div class="portlet-body" style="text-align: center; height: 416.07px;">
         <h4><strong><p class = "bginfo" id="chatLog3" class="chat_log3" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog4" class="chat_log4" readonly></p></strong></h4><br>
         <h4><strong><p class = "bginfo" id="chatLog8" class="chat_log8" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog11" class="chat_log11" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog14" class="chat_log14" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog17" class="chat_log17" readonly></p></strong></h4>
   	<img src="" id="img2" />
   </div>
   </div>
      </div>
      ...
      <div class="portlet-title">
         ...
         <div class="portlet-body" style="text-align: center; height: 416.07px;">
         <h4><strong><p class = "bginfo" id="chatLog5" class="chat_log5" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog6" class="chat_log6" readonly></p></strong></h4><br>
         <h4><strong><p class = "bginfo" id="chatLog9" class="chat_log9" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog12" class="chat_log12" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog15" class="chat_log15" readonly></p></strong></h4>
         <h4><strong><p class = "bginfo" id="chatLog18" class="chat_log18" readonly></p></strong></h4>
   	<img src="" id="img3" />
   </div>
   </div>
      </div>
...
<script type = "text/javascript">
   ...
   $.ajax({
      ...
      success: function(data) {
         ...
         var tomintemp = data.list[8].main.temp_min;
         var thmintemp = data.list[16].main.temp_min;
         var tomaxtemp = data.list[8].main.temp_max;
         var thmaxtemp = data.list[16].main.temp_max;
         var todayweather = data.list[0].weather[0].icon;
         var toweather = data.list[8].weather[0].icon;
         var thweather = data.list[16].weather[0].icon;
         var todayhumidity = data.list[0].main.humidity;
         var tohumidity = data.list[8].main.humidity;
         var thhumidity = data.list[16].main.humidity;
         var todayspeed = data.list[0].wind.speed;
         var tospeed = data.list[8].wind.speed;
         var thspeed = data.list[16].wind.speed;
         
         var imgURL1 = "http://openweathermap.org/img/w/" + todayweather + ".png";
         var imgURL2 = "http://openweathermap.org/img/w/" + toweather + ".png";
         var imgURL3 = "http://openweathermap.org/img/w/" + thweather + ".png";
         
         console.log("현재온도 : " + todaytemp);
         console.log("내일최저온도 : " + tomintemp);
         console.log("모레최저온도 : " + thmintemp);
         console.log("내일최고온도 : " + tomaxtemp);
         console.log("모레최고온도 : " + thmaxtemp);
         
         $('#chatLog1').append('오늘');
         $('#chatLog2').append(todaytemp + '˚');
         $('#chatLog3').append('내일');
         $('#chatLog4').append(tomintemp + '˚');
         $('#chatLog5').append('모레');
         $('#chatLog6').append(thmintemp + '˚');
         $('#chatLog7').append('습도');
         $('#chatLog8').append('습도');
         $('#chatLog9').append('습도');
         $('#chatLog10').append(todayhumidity + '%');
         $('#chatLog11').append(tohumidity + '%');
         $('#chatLog12').append(thhumidity + '%');
         $('#chatLog13').append('풍속');
         $('#chatLog14').append('풍속');
         $('#chatLog15').append('풍속');
         $('#chatLog16').append(todayspeed + 'm/s');
         $('#chatLog17').append(tospeed + 'm/s');
         $('#chatLog18').append(thspeed + 'm/s');
