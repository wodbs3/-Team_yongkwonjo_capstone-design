...
<![endif]-->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-3">
					<div id="logo">
						<a href="index.html"><img src="resources/img/logo_2x.png" width="160" height="34" alt="City tours" data-retina="complete" class="logo_normal">
						</a>
						<a href="index.html"><img src="resources/img/logo_sticky_2x.png" width="160" height="34" alt="City tours" data-retina="complete" class="logo_sticky">
						</a>
					</div>
				</div>
				<nav class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <img src="resources/img/logo_sticky_2x.png" width="160" height="34" alt="City tours" data-retina="complete">
                        </div>
				...
				<div class="col-md-3 col-sm-3">
					<div class="box_style_1">
						<div class="post nopadding">
							<img src="resources/img/blog-1.jpg" alt="Image" class="img-responsive">
					...
					<div id="comments">
						<ol>
							<li>
								<div class="avatar">
									<a href="#"><img src="resources/img/avatar1.jpg" alt="Image">
									</a>
								</div>
								...
								<ul>
									<li>
										<div class="avatar">
											<a href="#"><img src="resources/img/avatar2.jpg" alt="Image">
											</a>
										</div>
							...
							<li>
								<div class="avatar">
									<a href="#"><img src="resources/img/avatar3.jpg" alt="Image">
									</a>
								</div>
	...
	<footer class="revealed" style="z-index: 0; position: fixed; bottom: 0px; width: 1519px;">
        <div class="container">
            <div class="row">
